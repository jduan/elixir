...
defmodule FrequencyTest do
  ...
  test "divide empty list" do
    assert Frequency.divide([]) == []
  end

  test "divide a few paragraphs" do
    paragraphs = [
      "hello world",
      "this is an interesting story",
    ]
    assert Frequency.divide(paragraphs) == [
      "hello", "world", "this", "is", "an", "interesting", "story"
    ]
  end

  test "chunk short list" do
    assert Frequency.chunk(["hello"], 4) == [["hello"]]
  end

  test "chunk long list" do
    list = ["hello", "world", "this", "is", "an", "interesting", "story"]
    expected = [
      ["hello", "world"],
      ["this", "is"],
      ["an", "interesting"],
    ...
    actual = Frequency.chunk(list, 4) |> Enum.to_list
